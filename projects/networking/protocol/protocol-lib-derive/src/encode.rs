...
pub(super) fn derive_encode(item: TokenStream) -> Result<TokenStream> {
    ...
    add_trait_bounds(&mut input.generics, quote!(::slp_lib::__private::Encode));
    ...
    match input.data {
        Data::Struct(struct_) => {
            ...
            Ok(quote! {
                ...
                impl #impl_generics ::slp_lib::__private::Encode for #input_name #ty_generics
                #where_clause
                {
                    fn encode(&self, mut _w: impl ::std::io::Write) -> ::slp_lib::__private::Result<()> {
                        use ::slp_lib::__private::{Encode, Context};
        ...
        Data::Enum(enum_) => {
            ...
            Ok(quote! {
                ...
                {
                    fn encode(&self, mut _w: impl ::std::io::Write) -> ::slp_lib::__private::Result<()> {
                        use ::slp_lib::__private::{Encode, VarInt, Context};
