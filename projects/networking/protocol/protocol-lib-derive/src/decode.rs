...
pub(super) fn derive_decode(item: TokenStream) -> Result<TokenStream> {
    ...
    match input.data {
        Data::Struct(struct_) => {
            ...
            add_trait_bounds(
                &mut input.generics,
                quote!(::slp_lib::__private::Decode<#lifetime>),
            );
            ...
            Ok(quote! {
                ...
                impl #impl_generics ::slp_lib::__private::Decode<#lifetime> for #input_name #ty_generics
                #where_clause
                {
                    fn decode(_r: &mut &#lifetime [u8]) -> ::slp_lib::__private::Result<Self> {
                        use ::slp_lib::__private::{Decode, Context, ensure};
        ...
        Data::Enum(enum_) => {
            ...
            Ok(quote! {
                ...
                {
                    fn decode(_r: &mut &#lifetime [u8]) -> ::slp_lib::__private::Result<Self> {
                        use ::slp_lib::__private::{Decode, Context, VarInt, bail};
